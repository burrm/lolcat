...
spc.chart.variables.individual.and.movingrange.generic.simple <- function(
    individuals
    ...
    ,chart1.zone.ab.upper      = chart1.center.line + (2/3)*(chart1.control.limits.ucl-chart1.center.line)
    ,chart1.zone.bc.upper      = chart1.center.line + (1/3)*(chart1.control.limits.ucl-chart1.center.line)


    ,chart1.control.limits.lcl = chart1.center.line - 2.6587*3*chart2.center.line/3
    ,chart1.zone.a.lower       = chart1.control.limits.lcl
    ,chart1.zone.ab.lower      = chart1.center.line - (2/3)*(chart1.center.line-chart1.control.limits.lcl)
    ,chart1.zone.bc.lower      = chart1.center.line - (1/3)*(chart1.center.line-chart1.control.limits.lcl)
    ...
    ,chart2.zone.ab.upper      = chart2.center.line + (2/3)*(chart2.control.limits.ucl-chart2.center.line)
    ,chart2.zone.bc.upper      = chart2.center.line + (1/3)*(chart2.control.limits.ucl-chart2.center.line)
    ...
    ,chart2.zone.ab.lower      = chart2.center.line - (2/3)*(chart2.center.line-chart2.control.limits.lcl)
    ,chart2.zone.bc.lower      = chart2.center.line - (1/3)*(chart2.center.line-chart2.control.limits.lcl)
