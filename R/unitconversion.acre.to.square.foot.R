#' Unit Conversion - Area - Acre to Square Foot  
#' 
#' Performs a conversion of areas from acres to square feet. Note, per NIST standard, this is a "survey foot"
...
#'
#' @param x Vector - Values in units of acres
#'
...
unitconversion.acre.to.square.foot <- function(
  x = 1
) {
  x * 43560
}

#' @rdname unitconversion.acre.to.square.foot
unitconversion.ac.to.sq.ft <- unitconversion.acre.to.square.foot