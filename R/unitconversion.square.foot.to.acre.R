#' Unit Conversion - Area - Square Foot to Acre  
#' 
#' Performs a conversion of areas from square feet to acres. Note, per NIST standard, this is a "survey foot"
...
unitconversion.square.foot.to.acre <- function(
  x = 1
) {
  x / 43560
}

#' @rdname unitconversion.square.foot.to.acre
unitconversion.sq.ft.to.ac <- unitconversion.square.foot.to.acre